...
class DomainDetailedMovieExample {
    companion object {
        ...
        val domainDetailMovie1 =
            DomainDetailedMovie(
                adult = false,
                backdropPath = "$imagesLinkForTest/4hBteCcQw7kahNtYApbf45f9Dy0.jpg",
                genres = "drama, horror",
                homepage = "",
                id = 5245,
                originalLanguage = "en",
                ...
                posterPath = "$imagesLinkForTest/ilk4mLITsnR4JY8mpPIqPSgYrtg.jpg",
        ...
        val domainDetailMovie2 =
            DomainDetailedMovie(
                adult = false,
                backdropPath = "$imagesLinkForTest/mCVQ2cZmGkAHG2Q3fDZTQA1YzeI.jpg",
                genres = "drama, comedy",
                ...
                posterPath = "$imagesLinkForTest/gLhHHZUzeseRXShoDyC4VqLgsNv.jpg",
        ...
        val domainDetailMovie3 =
            DomainDetailedMovie(
                adult = true,
                backdropPath = imagesLinkForTest,
                genres = "horror",
                homepage = "",
                id = 4205,
                originalLanguage = "en",
                ...
                posterPath = "$imagesLinkForTest/3wkKgbuv4jRSd9TxPQhbDrPoCwc.jpg",
